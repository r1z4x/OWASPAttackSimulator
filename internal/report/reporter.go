...
<body class="bg-gray-50 min-h-screen">
        ...
        <div class="relative top-10 mx-auto p-5 border w-11/12 md:w-4/5 lg:w-3/4 xl:w-2/3 shadow-lg rounded-md bg-white max-h-[90vh] overflow-y-auto">
            <div class="mt-3">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="text-xl font-medium text-gray-900">Varyant Türleri Filtresi</h3>
                ...
                <div class="mb-6 grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <div class="relative h-fit">
                        <input type="text" id="variantSearch" placeholder="Varyant türü ara..." 
                    ...
                    <div class="flex flex-wrap gap-2 items-center justify-end">
                        ...
                        <div class="text-sm text-gray-600 ml-2">
                            <span id="selected-variant-count">0</span> varyant seçildi
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {{range $category, $variants := .AvailableVariants}}
                    <div class="variant-category">
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="flex items-center variant-item">
                                <input type="checkbox" class="variant-filter mr-3" data-variant="{{$variant}}" data-category="{{$category}}">
            ...
            <div class="mt-3">
                ...
                <div class="mb-6 grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <div class="flex flex-wrap gap-2 items-center justify-end">
                        ...
                        <div class="text-sm text-gray-600 ml-2">
                            <span id="selected-category-count">0</span> kategori seçildi
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-3">
                    <label class="flex items-center category-item">
                        ...
                        <span class="text-sm font-medium text-gray-700">Tüm Kategoriler</span>
                    </label>
                    <label class="flex items-center category-item">
	...
	data := struct {
		...
		AvailableVariants map[string][]string
	}{
		...
		AvailableVariants: r.getAvailableVariants(),
	}
...
// getAvailableVariants returns all available variant types from mutator
func (r *Reporter) getAvailableVariants() map[string][]string {
	variants := make(map[string][]string)

	// Get all attack types from common package
	attackTypes := []common.AttackType{
		// A01: Broken Access Control
		common.AttackBrokenAccessControl,
		common.AttackIDOR,
		common.AttackPrivilegeEscalation,
		common.AttackJWTManipulation,

		// A02: Cryptographic Failures
		common.AttackWeakCrypto,
		common.AttackWeakHashing,
		common.AttackInsecureTransport,
		common.AttackWeakRandomness,

		// A03: Injection
		common.AttackXSS,
		common.AttackSQLi,
		common.AttackCommandInj,
		common.AttackLDAPInjection,
		common.AttackNoSQLInjection,
		common.AttackHeaderInjection,
		common.AttackTemplateInjection,

		// A04: Insecure Design
		common.AttackBusinessLogicFlaw,
		common.AttackRaceCondition,
		common.AttackInsecureWorkflow,

		// A05: Security Misconfiguration
		common.AttackDefaultCredentials,
		common.AttackDebugMode,
		common.AttackVerboseErrors,
		common.AttackMissingHeaders,
		common.AttackWeakCORS,

		// A06: Vulnerable Components
		common.AttackKnownVulnerability,
		common.AttackOutdatedComponent,
		common.AttackVersionDisclosure,

		// A07: Authentication Failures
		common.AttackWeakAuth,
		common.AttackSessionFixation,
		common.AttackSessionTimeout,
		common.AttackWeakPassword,
		common.AttackBruteForce,

		// A08: Software and Data Integrity Failures
		common.AttackInsecureDeserialization,
		common.AttackCodeInjection,
		common.AttackSupplyChainAttack,

		// A09: Security Logging and Monitoring Failures
		common.AttackLogInjection,
		common.AttackLogBypass,
		common.AttackAuditTrailTampering,

		// A10: Server-Side Request Forgery
		common.AttackSSRF,
		common.AttackXXE,
		common.AttackOpenRedirect,
	}

	// Group attack types by OWASP category
	for _, attackType := range attackTypes {
		category := r.getOWASPCategoryForAttackType(attackType)
		variants[category] = append(variants[category], string(attackType))
	}

	return variants
}

// getOWASPCategoryForAttackType returns the OWASP category for a given attack type
func (r *Reporter) getOWASPCategoryForAttackType(attackType common.AttackType) string {
	switch attackType {
	// A01: Broken Access Control
	case common.AttackBrokenAccessControl, common.AttackIDOR, common.AttackPrivilegeEscalation, common.AttackJWTManipulation:
		return "A01:2021 - Broken Access Control"

	// A02: Cryptographic Failures
	case common.AttackWeakCrypto, common.AttackWeakHashing, common.AttackInsecureTransport, common.AttackWeakRandomness:
		return "A02:2021 - Cryptographic Failures"

	// A03: Injection
	case common.AttackXSS, common.AttackSQLi, common.AttackCommandInj, common.AttackLDAPInjection, common.AttackNoSQLInjection, common.AttackHeaderInjection, common.AttackTemplateInjection:
		return "A03:2021 - Injection"

	// A04: Insecure Design
	case common.AttackBusinessLogicFlaw, common.AttackRaceCondition, common.AttackInsecureWorkflow:
		return "A04:2021 - Insecure Design"

	// A05: Security Misconfiguration
	case common.AttackDefaultCredentials, common.AttackDebugMode, common.AttackVerboseErrors, common.AttackMissingHeaders, common.AttackWeakCORS:
		return "A05:2021 - Security Misconfiguration"

	// A06: Vulnerable Components
	case common.AttackKnownVulnerability, common.AttackOutdatedComponent, common.AttackVersionDisclosure:
		return "A06:2021 - Vulnerable and Outdated Components"

	// A07: Authentication Failures
	case common.AttackWeakAuth, common.AttackSessionFixation, common.AttackSessionTimeout, common.AttackWeakPassword, common.AttackBruteForce:
		return "A07:2021 - Identification and Authentication Failures"

	// A08: Software and Data Integrity Failures
	case common.AttackInsecureDeserialization, common.AttackCodeInjection, common.AttackSupplyChainAttack:
		return "A08:2021 - Software and Data Integrity Failures"

	// A09: Security Logging and Monitoring Failures
	case common.AttackLogInjection, common.AttackLogBypass, common.AttackAuditTrailTampering:
		return "A09:2021 - Security Logging and Monitoring Failures"

	// A10: Server-Side Request Forgery
	case common.AttackSSRF, common.AttackXXE, common.AttackOpenRedirect:
		return "A10:2021 - Server-Side Request Forgery"

	default:
		return "A03:2021 - Injection" // Default to Injection for unknown types
	}
}
